...
const About = () => {
  return (
    <div id='about' className='container mx-auto p-4 md:p-24 text-black relative'>
      ...
      <div className="relative z-10">
        ...
        <ul className='list-disc pl-4 md:pl-8 mb-4 mx-auto text-xl md:text-xl font-medium '>
          <li className='mb-2 p-2 md:p-2 transition duration-500 ease-in-out transform hover:scale-105'>
